...
/**
 * This is a generic InstanceCreator for {@link EnumMap}s. It works by using a
 * somewhat hackish way to not-specifying the Types and taking advantage of
 * type-erasure. This enables us to use the same InstanceCreator for every
 * {@link EnumMap}, regardless of the type of the enum.
 *
    ...
    public EnumMap<K, V> createInstance(Type type) {
        if (type instanceof ParameterizedType) {
            ...
            if (t.getActualTypeArguments()[0] instanceof Class) {
                ...
                throw new IllegalArgumentException("The generic "
